...
def test_java_bouncy_castle_ccm_matching():
    K = "404142434445464748494a4b4c4d4e4f".decode("hex")
    N = "10111213141516".decode("hex")
    P = "68656c6c6f20776f726c642121".decode("hex")
    C = "39264f148b54c456035de0a531c8344f46db12b388".decode("hex")
